...
// 	                document.getElementById('cafeAddr1').value = '(예상 도로명 주소 : ' + expRoadAddr + ')';
	
// 	            } else if(data.autoJibunAddress) {
// 	                var expJibunAddr = data.autoJibunAddress;
// 	                document.getElementById('cafeAddr1').value = '(예상 지번 주소 : ' + expJibunAddr + ')';
// 	            } else {
// 	            	document.getElementById('cafeAddr1').value = '';
// 	            	document.getElementById('cafeAddr1').style.display = 'none';
// 	            } 
	        }
	    }).open();
	}
	...
	<div class="form-group">
		<div>
			...
			<div class="col-sm-10 bottom5 form-inline">
				<input type="text" class="form-control" id="cafeZip"
		...
		<div>
			...
			<div class="col-sm-10 bottom5">
				<input  type="text" readonly="readonly" class="form-control" id="cafeAddr1" name="cafeAddr1">
			</div>
		</div>
		<div>
			<label class="control-label col-sm-2" for="cafeAddr2">상세주소:</label>
			<div class="col-sm-10">
				<input type="text" class="form-control" id="cafeAddr2"
