...
<body>	
	...
	<div class="container divPadding marginBottom30">
		...
		<form class="form-horizontal divPadding" id="fm" action="<%=request.getContextPath() %>/gsFeedUpdate.do" method="post" enctype="multipart/form-data">

			<div class="form-group">
					<input type="hidden" class="form-control"
						   id="gsFeedNo" name="gsFeedNo" value="<%=gsFeedVO.getGsFeedNo()%>">
			</div>
			...
			<div class="form-group">	
				...
				<div class="col-xs-8">
					<input type="text" class="form-control form-inline"
						   id="gsFeedTitle" name="gsFeedTitle" value="<%=gsFeedVO.getGsFeedTitle()%>">
				</div>				
			</div>
			...
			<label for="gsFeedUserId" class="control-label col-xs-2">작성자</label>
				<div class="col-xs-8">
					<input type="text" class="form-control form-inline"
						   id="gsFeedUserId" name="userId" value="<%=gsFeedVO.getUserId()%>">
				</div>				
			</div>
			...
			<div class="form-group" >
				...
				<div class="col-xs-8">
					<textarea class="inputContent form-control form-inline" rows="10" 
							  id="gsFeedContent" name="gsFeedContent"><%=gsFeedVO.getGsFeedContent()%></textarea>
				</div>				
			</div>
